...
public class ArrayListPracticeKyle {
    ...
    public static void main(String[] args) {
        ...
        Integer searchLength = ArrayListPracticeKyle.getUserSearchInput();
        ArrayListPracticeKyle.printWordsWithFiveLetters(wordsToSearch, searchLength);
    }
